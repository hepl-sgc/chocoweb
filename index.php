                    ...
                    <div class="owl-carousel owl-theme">
                         <div class="item item-first">
                              <figure class="item__bg">
                                   <img src="/content/slide1.jpg" alt="Une préparation à base de chocolat dans une bol" class="item__img">
                              </figure>
                              <div class="caption">
                                   <div class="container">
                         ...
                         <div class="item item-second">
                              <figure class="item__bg">
                                   <img src="/content/slide2.jpg" alt="Des cookies tout chauds, fraichement sortis du four" class="item__img">
                              </figure>
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-8 col-sm-12">
                         ...
                         <div class="item item-third">
                              <figure class="item__bg">
                                   <img src="/content/slide3.jpg" alt="Un gâteau au chocolat décoré d'une framboise" class="item__img">
                              </figure>
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-8 col-sm-12">
